...
class ReservationController extends Controller
{
    ...
    public function getRoomByCategory($id_category) // Ke app.blade.php bagian <script></script> bwt context
    {
        try {
            //code...
            ...
            //throw $th;
            return response()->json(['message' => 'Erorrrr', 'error' => $th->getMessage()]);
        }
    }
}
